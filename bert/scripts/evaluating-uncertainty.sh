...
# python main.py --evaluate --model-save-path /scratch/connectome/ycryu/UQ/bert/bert-checkpoints/checkpoint_20250123_022226_epoch1.pt --uncertainty --dropout-rate 0.5 > /scratch/connectome/ycryu/UQ/bert/test_result/epoch1-50-3.log